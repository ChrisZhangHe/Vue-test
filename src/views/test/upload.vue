<template>
  <div>
    ...
    <el-upload
      ref="upload"
      action="http://202.61.88.250:8902/data/file/upload"
...
// formData.append('__debug__',1);
// formData.append('file',dataURLtoFile(base64, "imgName"));
// axios.axios
//   .request({
//     url: "http://202.61.88.250:8902/data/file/upload",
//     method: "post",
//     data:formData,
